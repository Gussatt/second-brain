...
- [Step 1: Choose transcription method](#step-1-choose-transcription-method)
  - [Option A: Local — walkthrough if not set up](#option-a-local--walkthrough-if-not-set-up)
  - [Option B: ElevenLabs Scribe — walkthrough if not set up](#option-b-elevenlabs-scribe--walkthrough-if-not-set-up)
- [Step 2: Extract audio](#step-2-extract-audio)
- [Step 3: Transcribe + diarize](#step-3-transcribe--diarize)
  - [Option A: Local (mlx_whisper + pyannote)](#option-a-local-mlxwhisper--pyannote)
  - [Option B: ElevenLabs Scribe](#option-b-elevenlabs-scribe)
- [Step 4: Summarize](#step-4-summarize)
- [Step 5: Create vault notes](#step-5-create-vault-notes)
  - [Transcript file](#transcript-file)
  - [Call note](#call-note)
  - [Person notes](#person-notes)
  - [Daily note](#daily-note)
- [Step 6: Handle mid-call name-drops](#step-6-handle-mid-call-name-drops)
...
| `02 Daily/YYYY/MM/` | Daily notes, named `DD-MM-YY ddd.md` |
...
- **Concepts / companies / products**: create in `06 Wiki/pages/` (or `$REFERENCES_DIR` if you have the `/summarize` skill installed) with a 2-4 sentence explanation
